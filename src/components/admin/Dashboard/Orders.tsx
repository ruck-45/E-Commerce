...
import OrderModal from "../../../components/Profile/subComponents/OrderModal"; // Import the modal component
...
function MyOrders() {
  ...
  return (
    <div className="content-wrapper">
        <h1 style={{textAlign:'center',fontSize:'20px',fontWeight:'700'}}>Total Orders : {orders.length}</h1>
