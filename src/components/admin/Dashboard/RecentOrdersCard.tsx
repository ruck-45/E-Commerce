...
const OrdersCard: React.FC<OrdersCardProps> = ({ order }) => {
  return (
    <div className="bg-gray-100 rounded-lg border border-gray-200 shadow-md my-4 w-full md:w-full relative flex flex-wrap flex-shrink-0">
      ...
      <span className="absolute top-0 right-0 text-white rounded-tr-lg rounded-bl-lg  p-2">
