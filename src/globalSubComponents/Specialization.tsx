    ...
    <div className="bg-[black] flex flex-col items-center text-white px-[2rem] py-[5rem] gap-[3rem]">
      <div className="text-center">
        ...
        <p className="text-default-400 max-w-[35rem]">
          At Shop Nest, we're passionate about crafting innovative brand solutions. We seamlessly blend technology and
          design with cutting-edge visual storytelling, giving our clients a competitive edge in the digital realm. This
          approach has empowered us to establish partnerships across diverse industries.
        </p>
      </div>
