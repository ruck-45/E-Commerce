...
const HomeCard = () => {
  return (
    <div className="px-[3rem] md:px-[5rem] py-[3rem]">
      <div
        className="md:px-[5rem] py-[5rem] flex justify-center md:justify-end bg-no-repeat bg-top bg-cover"
        style={{
          backgroundImage:
      ...
      >
        <div className="md:mr-[5rem] p-[2rem] bg-[rgba(0,0,0,0.5)] text-white">
