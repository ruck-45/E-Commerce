  ...
  return (
    <>
      ...
      <div className="h-auto md:p-[5rem] p-[2rem] flex flex-col items-start justify-between">
        <h3 className="font-semibold py-[0.5rem]">Terms and Conditions for ShopNest Ecommerce App:</h3>
        ...
        <div className="py-[0rem]">
          <h3 className="font-semibold">3.Product Listings and Purchases:</h3>
          <div className="py-[1rem]">
            <ul className="text-gray-600 list-disc px-[2rem]">
              <li className="py-[0.5rem]">
        ...
        <div className="py-[0rem]">
          <h3 className="font-semibold">6. Disclaimer of Warranties:</h3>
          <div className="py-[1rem]">
            <ul className="text-gray-600 list-disc px-[2rem]">
              <li className="py-[0.5rem]">
        ...
        <div className="py-[0rem]">
          <h3 className="font-semibold">9. Changes to These Terms and Conditions:</h3>
          <div className="py-[1rem]">
            <ul className="text-gray-600 list-disc px-[2rem]">
              <li className="py-[0.5rem]">
