  ...
  return (
    <>
      ...
      <div className="h-auto md:p-[5rem] p-[2rem] flex flex-col items-start justify-between">
        <h3 className="font-semibold py-[0.5rem]">Refund and Cancellation Policy for ShopNest Ecommerce App</h3>
        ...
        <div className="py-[1rem]">
          <h3 className="font-semibold">1. Cancellation Policy:</h3>
        ...
        <div className="py-[0rem]">
          <h3 className="font-semibold">3. Return Shipping:</h3>
          <div className="py-[1rem]">
            <ul className="text-gray-600 list-disc px-[2rem]">
              <li className="py-[0.5rem]">
        ...
        <div className="py-[0rem]">
          <h3 className="font-semibold">4. Contact Us:</h3>
          <div className="py-[1rem]">
            <ul className="text-gray-600 list-disc px-[2rem]">
              <li className="py-[0.5rem]">
        ...
        <div className="py-[0rem]">
          <h3 className="font-semibold">5. Changes to This Policy:</h3>
          <div className="py-[1rem]">
            <ul className="text-gray-600 list-disc px-[2rem]">
              <li className="py-[0.5rem]">
            ...
            <p className="p-[2rem] font-medium">
