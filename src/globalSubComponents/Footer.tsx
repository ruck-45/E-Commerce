      ...
      <div className="flex gap-[4rem] upperFooter">
        <div className="max-w-[20rem] flex flex-col gap-[2rem] companySection">
          ...
          <p className="text-justify text-sm">
            Shop Nest is a unit of <span className="font-bold">HMS Freedom LLC</span>, we're a lively digital marketing
            agency that's all about crafting innovative solutions for businesses like yours, helping you build a robust
            online presence that truly stands out. Driven by a ferocious hunger to create tangible impact for your
            brands, we work with in-house specialists, industry partners and technology leaders to push the boundaries
            of creativity and put your brand ahead of the competition.
          </p>
          ...
          <div className="flex text-[1.8rem] gap-[1rem]">
            ...
            <a href="https://www.youtube.com/@ShopNest-23" target="_blank" rel="noreferrer">
              <TbBrandYoutubeFilled className="mt-[0.4rem] cursor-pointer hover:scale-105" />
            </a>
            <a href="https://www.instagram.com/ShopNest23/" target="_blank" rel="noreferrer">
              <AiFillInstagram className="mt-[0.4rem] cursor-pointer hover:scale-105" />
            </a>
            <a href="https://www.pinterest.com/ShopNest23/" target="_blank" rel="noreferrer">
