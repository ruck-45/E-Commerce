...
export default function RecentOrders() {
  return (
    <div className="bg-white px-4 pt-3 pb-4 h- rounded-sm border border-gray-200 flex-1">
          ...
          <tbody>
            {recentOrderData.map((order) => (
              <tr key={order.id} className="border-b border-gray-200">
                ...
                <td className="px-4 py-2">
                  <span className="inline-block text-white px-2 py-1 rounded-md whitespace-nowrap">
