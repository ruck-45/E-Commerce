  ...
  return (
    <div className="bg-white h-auto text-white mt-[0rem]">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-[1rem] p-[3rem]">
        <div className=" firstSection  firstSection flex flex-col items-end justify-center lg:h-[33rem] w-full lg:w-[50rem] rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col justify-center items-start gap-4 attractive-small">
          <div className="rounded-2xl secondSection flex flex-col justify-between items-start h-[16rem] w-full lg:w-[30rem] shadow-xl">
          ...
          <div className="thirdSection flex flex-col justify-between items-start h-[16rem] w-full lg:w-[30rem] rounded-2xl shadow-xl">
            <div className="ml-[3rem] p-[1rem] h-full bg-[rgba(0,0,0,0.5)] ">
              <div className="py-[0.5rem]">
