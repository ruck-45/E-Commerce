  ...
  return (
    <div className="h-screen flex flex-row items-center justify-between bg-white">
      <div
        ...
        style={{
          backgroundImage:
            "url(https://images.unsplash.com/photo-1534889156217-d643df14f14a?q=80&w=1528&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
        }}
      ></div>
